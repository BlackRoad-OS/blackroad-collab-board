# Contributing to blackroad-collab-board
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-collab-board.git
cd blackroad-collab-board

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-collab-board.git
